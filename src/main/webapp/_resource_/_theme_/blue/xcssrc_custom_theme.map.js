            						...
            						"parent" :
            						{
            							"GridCellControl" :
            							{
            								"self" :
            								{
            									"expand" :
            									{
            										"icon" : nexacro.UrlObject("URL('theme://images/btn_tree_menu.png')")
            									},
            									"collapse" :
            									{
            										"icon" : nexacro.UrlObject("URL('theme://images/btn_tree_menu.png')")
            						...
            						"sta_LF_title01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"font" : nexacro.FontObject("normal 600 18px \"Malgun Gothic\",\"Arial\""),
            					...
            					},
            					{
            						"sta_RT_title02" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#101010"),
            									"font" : nexacro.FontObject("normal 600 10px \"Malgun Gothic\",\"Arial\""),
            									"border" : nexacro.BorderObject("0px solid #c7c7c7, 0px solid #c7c7c7, 0px solid #c7c7c7, 0px solid #c7c7c7"),
            									"padding" : nexacro.PaddingObject("0px 0px 0px 45px")
            								}
            							}
